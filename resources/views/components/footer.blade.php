            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="footer-infor d-flex flex-column align-items-start mb-lg-0">
                        ...
                        <a href="tel:3156666688" class="cl-text-2 link mb-16"> 315-666-6688 </a>
                    ...
                    <div class="footer-col-block footer-wrap-2 mx-xl-auto">
                        ...
                        <div class="tf-collapse-content">
                            <ul class="footer-menu-list">
                                ...
                                <li><a href="return-and-refund.html" class="cl-text-2 link">Return & Refund</a></li>
                                <li><a href="privacy-policy.html" class="cl-text-2 link">Privacy Policy</a></li>
                                <li><a href="term-and-condition.html" class="cl-text-2 link">Terms & Conditions</a></li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="footer-col-block footer-wrap-3 mb-0">
                        ...
                        <div class="tf-collapse-content">
                            <p class="footer-desc cl-text-2">Subscribe for store updates and discounts.</p>
                            <form class="form-sub">
                                <fieldset>
                            ...
                            <p class="text-remember cl-text-2">
                                ...
                                <a href="term-and-condition.html" class="text-main link link-underline">
                                    Terms of Service
                                </a>
                                and
                ...
                <div class="tf-list list-currenci">
                    <div class="tf-currencies">
                        <select class="tf-dropdown-select style-default type-currencies">
                            <option selected data-thumbnail="{{ asset('website/assets/images/country/us.png') }}">
                                United States (USD $)
                            </option>
                            <option data-thumbnail="{{ asset('website/assets/images/country/vn.png') }}">
                                Viet Nam (VND ₫)
                            </option>
                        </select>
                    </div>
...
<div class="offcanvas offcanvas-start canvas-mb" id="mobileMenu">
    ...
    <div class="canvas-body">
        ...
        <div class="need-help-wrap">
            ...
            <a href="mailto:hi.amere@gmail.com" class="cl-text-2 link mb-8"> hi.amere@gmail.com </a>
            <a href="tel:3156666688" class="cl-text-2 link"> 315-666-6688 </a>
        </div>
    </div>
        ...
        <div class="d-flex justify-content-center border-end">
            <div class="tf-currencies">
                <select class="tf-dropdown-select style-default type-currencies">
                    ...
                    <option data-thumbnail="{{ asset('website/assets/images/country/vn.png') }}">(VND ₫)</option>
                </select>
            </div>
        </div>
            ...
            <div class="modal-main">
                <form class="form-log">
                    ...
                    <div class="group-action">
                        <button type="submit" class="tf-btn animate-btn w-100">Get Reset Code</button>
            ...
            <div class="modal-main">
                <div class="tf-rte">
                    <div class="tf-table-res-df mb-20">
                        <p class="h6 fw-medium cl-text-main mb-16">Size Guide</p>
                    ...
                    <div class="tf-page-size-chart-content">
                        <div>
                            <p class="h6 fw-medium cl-text-main mb-16">Measuring Tips</p>
            ...
            <div class="modal-main">
                <form class="form-log mb-20">
                    <div class="form-content">
                        ...
                        <fieldset class="tf-field">
                            <label for="phone-ask" class="tf-lable fw-medium"> Your phone </label>
                    ...
                    <div class="group-action">
                        <button type="submit" class="tf-btn animate-btn w-100">Subcribe</button>
                    </div>
                </form>
        ...
        <div class="modal-content">
            ...
            <div class="tf-product-quick_add tf-quick-prd_variant">
                ...
                <div class="product-total-quantity">
                    ...
                    <a href="checkout.html" class="tf-btn type-xl btn-primary animate-btn w-100"> Buy It Now </a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="canvas-body ps-md-0">
            <div class="tf-product-quick_view tf-quick-prd_variant">
                <div class="tf-product-info-heading">
                    ...
                    <h3 class="product-infor-name letter-space-0 mb-12">Lyocell wrap top</h3>
                ...
                <div class="tf-product-variant">
                    ...
                    <div class="quick-variant-picker picker_size">
                        ...
                        <div class="variant-picker_values">
                            <span class="size_btn" data-quick-size="S" data-quick-price="39.99">S</span>
                            <span class="size_btn active" data-quick-size="M" data-quick-price="59.99">M</span>
                            <span class="size_btn" data-quick-size="L" data-quick-price="79.99">L</span>
                            <span class="size_btn" data-quick-size="XL" data-quick-price="89.99">XL</span>
                            <span class="size_btn disabled" data-quick-size="XX" data-quick-price="99.99">XXL</span>
                        </div>
                    </div>
            ...
            <div class="tf-mini-cart-wrap list-file-delete wrap-empty_text">
                        ...
                        <div class="tf-mini-cart-items list-empty">
                            <div class="box-text_empty type-shop_cart">
                                ...
                                <div class="shop-empty_bot">
                                    ...
                                    <a href="index-2.html" class="tf-btn btn-stroke">Back to home </a>
                                </div>
                            </div>
                            <div class="tf-mini-cart-item file-delete">
                                ...
                                <div class="tf-mini-cart-info">
                                    ...
                                    <div class="tf-prd-select select-color text-caption-01 mb-4">
                                    ...
                                    <div class="tf-prd-select text-caption-01">
                ...
                <div class="tf-mini-cart-tool-openable add-note">
                    ...
                    <form action="#" class="tf-mini-cart-tool-content">
                        ...
                        <div class="tf-cart-tool-btns">
                            <button class="subscribe-button tf-btn animate-btn" type="submit">Save</button>
                            <div class="tf-btn btn-stroke tf-mini-cart-tool-close">Cancel</div>
                        </div>
                    </form>
                </div>
                ...
                <div class="tf-mini-cart-tool-openable add-gift">
                    ...
                    <form action="#" class="tf-mini-cart-tool-content">
                        ...
                        <div class="tf-cart-tool-btns">
                            <button class="subscribe-button tf-btn animate-btn" type="submit">Add a gift</button>
                            <div class="tf-btn btn-stroke line tf-mini-cart-tool-close">Cancel</div>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-main">
                <form action="https://tfamerce.vercel.app/account-page.html" class="form-log">
                    ...
                    <div class="group-action">
                        ...
                        <a href="#sign" data-bs-toggle="modal" class="tf-btn btn-stroke"> Login </a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="form-content">
                        ...
                        <fieldset class="field-bottom">
                            ...
                            <a href="#modalForgot" data-bs-toggle="modal" class="link text-decoration-underline">
                                <span class="text-caption-01 fw-semibold"> Forgot Your Password? </span>
                            </a>
                        </fieldset>
                    </div>
                    <div class="group-action">
                        <button type="submit" class="tf-btn animate-btn w-100">Login</button>
                        <a href="#register" data-bs-toggle="modal" class="tf-btn btn-stroke"> Create Account </a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="image-left">
                <img loading="lazy" width="360" height="360"
                    src="{{ asset('website/assets/images/section/banner-newsletter.jpg') }}" alt="Image">
            </div>
